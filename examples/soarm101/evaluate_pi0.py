...
config = pi0_config.get_config("pi0_soarm101_lora")
...
pi0_policy = policy_config.create_trained_policy(config, checkpoint_dir="/home/i2rt/openpi/checkpoints/pi0_soarm101_lora/pi0_soarm101_lora_battery/17000/train_state")
print("Pi0 model loaded successfully")

# Connect to robot
# Use your robot IP and ID
robot_config = So101FollowerConfig(port="/dev/ttyACM1")
