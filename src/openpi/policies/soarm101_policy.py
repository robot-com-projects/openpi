...
def make_soarm101_example() -> dict:
    """Creates a random input example for the Soarm101 policy."""
    return {
...
class Soarm101Inputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        wrist_image = _parse_image(data["observation/images/side"])
...
@dataclasses.dataclass(frozen=True)
class Soarm101Outputs(transforms.DataTransformFn):
    """
    ...
    def __call__(self, data: dict) -> dict:
        ...
        # For Soarm101, we return the first 14 actions (7 per arm for bimanual setup).
