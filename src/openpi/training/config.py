...
@dataclasses.dataclass(frozen=True)
class LeRobotI2RTDataConfig(DataConfigFactory):
    """
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    {
                        # Map dataset keys to output keys (keep image keys as-is since I2RTInputs expects them)
                        ...
                        "observation/images/torso": "observation.images.torso",
                        "observation/images/teleop_left": "observation.images.teleop_left",
                        "observation/images/teleop_right": "observation.images.teleop_right",
        ...
        data_transforms = _transforms.Group(
            inputs=[i2rt_policy.I2RTInputs(model_type=model_config.model_type)],
            outputs=[i2rt_policy.I2RTOutputs()],
        )
